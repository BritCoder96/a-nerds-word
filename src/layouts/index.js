  ...
  <div>
    ...
    >
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <Sidebar
                  ...
                  description={<p>Bradley Woods is a full-stack software engineer, author, and all-around nerdy guy. His novels <i>Unbounded</i> and <i>R.A.C.H.E.L. Undying</i> are available <a href='https://amazon.com/dp/B0873YKZ5J' target='_blank'>here</a> and <a href='https://amazon.com/dp/B09XHDLFSQ' target='_blank'>here</a>, respectively, and you can visit his website <a href='https://bradleywoodsauthor.com' target='_blank'>here</a>.</p>}
                />
                <Sidebar
      ...
      <footer>
        ...
        <div></div>
        <div>Copyright © <script>{new Date().getFullYear()}</script> Bradley Woods. All Rights Reserved.</div>
      </footer>
    </div>
  </div>
);
